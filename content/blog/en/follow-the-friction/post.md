---
title: 'Follow the Friction: Why the Best AI Strategy Starts with Looking'
date: '2026-04-03'
intro: >-
...
Start with the work, not the technology. Go and sit next to employees and observe where the friction is: where do people lose time, where do they copy data between systems, where do they do work they know could be done smarter. Those observations are a better foundation for an AI strategy than any roadmap.

**What is Follow the Friction?**
Follow the Friction is the principle that the best AI opportunities become visible by observing where work gets stuck. Instead of sitting in a meeting room to work out where AI might help, you go and watch where employees encounter friction day to day. Those places are almost always the places where AI has the most impact.

**How do you determine where AI adds the most value?**
By combining three things: where does the most daily friction occur (observation), where are employees already informally using AI tools (Shadow AI as a signal), and where can AI genuinely help (match with AI capabilities: reading, interpreting, generating, deciding). The overlap of those three is your starting point.

**What is a Process Friction Map?**
A Process Friction Map is a visual inventory of where energy is leaking from an organisation. For each process, you map where waiting times occur, where manual actions are required, where data is being retyped, and where workarounds have emerged. That map is the foundation for targeted AI investment.

**How long does it take to develop an AI strategy?**
A focused AI strategy for a specific domain can be ready within a week. The key is focus: choose one team, one process, one clearly defined piece of work. Broad AI strategies that span the entire organisation take months and rarely produce concrete results. Start small, learn fast, and expand based on evidence.
