...
## Frequently Asked Questions about the AI adoption race

**What is the difference between the frontier race and the adoption race?**
The frontier race is about who builds the smartest AI model — it is a battle over strategic power and infrastructure, and Europe is lagging there. The adoption race is about who applies AI the fastest and the smartest in practice. That race determines the actual productivity gains and is still wide open.

**Why does Europe not need to win the frontier race?**
With fundamental technologies, most of the economic value is added by whoever applies the technology, not by whoever invents it. The digital sector is only around 10% of GDP; the other 90% — manufacturing, logistics, retail, healthcare — is where AI delivers the most. With its strong manufacturing base, Europe holds a trump card there.

**Why small, specific AI models instead of large super-models?**
For around 90% of business tasks — reading an order, routing a customer query, quality control on the production line — a small, specifically trained model is perfect. It is cheaper, faster, and runs on your own infrastructure. That makes complying with the EU AI Act easier: your data stays within your own walls and the model is explainable.

**What does "there is no last mover advantage" mean?**
The company that starts adopting AI today builds a lead that later entrants cannot simply buy back — not with a better model and not with more money. You build up process data, your people learn to work with AI, and successful use cases stack up. That learning capacity grows quarter after quarter and cannot be caught up with technology alone.

**How do you start with AI adoption in your organisation?**
Begin small, but broadly supported. Pick a concrete process, prove the value in practice, and scale what works. Do not wait for the "perfect moment" or "better models" — the real price of slowness is your competitor's growing learning advantage.
