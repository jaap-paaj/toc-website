---
title: 'AI readiness: why most assessments measure the wrong things'
date: '2026-04-03'
intro: >-
...
An AI readiness scan or workshop at The Only Constant costs between €1,500 and €3,500, depending on scope. The result is a concrete picture of where AI can add the most value in your organisation, plus a starting point to act on immediately. Extended readiness engagements with a first working automation start from €5,000.

**How long does it take to become AI-ready?**
A first focused experiment can deliver results in ninety days: from strategic question to decision data. The key is focus: choose one domain, one team, one process. Broad AI readiness programmes that cover the whole organisation take longer and paradoxically deliver less, because they lack the focus needed to genuinely learn.

**What are the biggest obstacles to AI readiness?**
Three things that hold organisations back most often: lack of focus (wanting to start everywhere at once), lack of mandate (no sponsor with the authority to stop when something is not working), and lack of honesty (measuring to prove it works instead of to learn what is actually happening). Technology and data are rarely the real obstacle.
