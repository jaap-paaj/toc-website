...
The EU AI Act is European legislation that places requirements on AI systems based on risk classification. High-risk applications (such as AI for recruitment or creditworthiness assessment) require human oversight, documentation, and transparency. Most business applications fall under limited risk and primarily require transparency: communicating that AI is being used and explaining what it does.

**When does the EU AI Act come into effect?**
The AI Act was adopted in 2024 and is being phased in. The first obligations (prohibited AI applications) have applied since February 2025. Transparency requirements for general-purpose AI apply from August 2025. The full regulation, including high-risk requirements, is in force from August 2026.

**Does the EU AI Act apply to my business?**
If your organisation uses or provides AI systems within the EU: yes. The Act applies to providers of AI systems, users of AI systems, and importers. Even if an AI system was developed outside the EU but is deployed within the EU, it falls under the regulation.

**What do I need to do to be compliant?**
For most business applications (limited risk): communicate that AI is being used, document what the system does and what data it uses, and ensure you can explain why it does what it does. For high-risk applications, the requirements are stricter: human oversight, extensive documentation, and a conformity assessment.

**What is AI literacy according to the AI Act?**
The AI Act requires organisations to ensure that employees who work with AI have sufficient knowledge to use it responsibly. This does not mean everyone needs technical training. It means that people understand what the system does, where the limits are, and when human judgement is needed. Practical AI workshops focused on your own processes are the most effective way to achieve this.
