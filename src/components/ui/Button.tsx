...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-surface text-sm font-medium transition-all " +
  ...
  "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border bg-background shadow-surface hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-border dark:hover:bg-input/50",
        secondary:
      ...
      size: {
        ...
        sm: "h-8 rounded-surface gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-10 rounded-surface px-6 has-[>svg]:px-4",
        xl: "h-14 rounded-full px-8 text-base", // Hero CTA size
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
