...
Start not with the technology but with the friction. Sit next to someone doing the work and watch where things get stuck. Choose the process with the most daily pain and build a small, working automation for it. Test it with real users, measure the result, and only scale when it has proven its value.
