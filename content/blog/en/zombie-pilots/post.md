---
title: 'Zombie Pilots: Why Your AI Projects Never Get Off the Ground'
date: '2026-04-03'
intro: >-
...
Most AI pilots do not fail technically. They fail organisationally. There is no owner to take responsibility after the pilot phase, success criteria are vague or absent, and there is no mechanism to force a hard decision. The result: pilots that run indefinitely without direction.

**How do you prevent a Zombie Pilot?**
By agreeing on three things before you start: an end date, an owner, and clear success criteria. At the end of the pilot period, you force one of four decisions: scale, adjust, change direction, or stop. "We're keeping an eye on it" is not an option.

**How do you know if an AI pilot is successful?**
Measure whether real people are using the system voluntarily during their normal working day. The simplest test: threaten to switch it off. If users protest, you have found value. If nobody notices, that is also an answer. Always measure in pairs: speed alongside quality, cost savings alongside user satisfaction.

**How long should an AI pilot last?**
Two to four weeks for a first experiment. That is enough to test whether an AI solution adds value to a specific process. Pilots that run for months without clear decision points are a risk: they consume money and energy without bringing the organisation any closer to a decision.

**What do you do with an AI pilot that is not working?**
Stop it. Document what you learned and use that knowledge for the next experiment. A stopped project that produces insights is more valuable than a running project that proves nothing. The most expensive AI investment is a pilot that nobody dares to make a decision about.
