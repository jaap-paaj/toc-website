...
A good AI workshop combines three things: understanding what AI can and cannot do (and where the limits are), insight into where AI adds value to your specific work, and a concrete starting point to begin. It deliberately goes beyond a tool demonstration. Participants leave with a clear picture of which processes in their organisation are most suited to AI, and a plan to start next week.

**How much does an AI workshop cost?**
An in-company AI workshop at The Only Constant costs between €1,500 and €3,500, depending on the scope and preparation involved. This includes an intake to tailor the workshop to your situation, the session itself, and a follow-up with concrete next steps. Public workshops and training programmes start from €1,500 per group.

**How long does an AI workshop take?**
Allow half a day for an AI workshop (3–4 hours) and a full day for a hands-on session where the team actually works through their own processes. The most effective workshops combine a morning of theory and context with an afternoon where participants work on their own use cases.

**Who is an AI workshop suited for?**
AI workshops are most effective for teams that work daily with processes where friction exists: customer service, marketing, operations, finance, HR. The ideal group is 8 to 20 participants from the same organisation, preferably a mix of management and practitioners. The combination of people who set strategy and people who do the work produces the richest insights.

**What is the difference between an AI workshop and AI training?**
Training focuses on skills: how to use specific tools, how to write effective prompts, how to integrate AI into your daily workflow. A workshop focuses on strategy and direction: where is the most value for our organisation, which processes are suitable, and how do we begin. At The Only Constant, we combine both: set direction first, then build capability.

**How do I prepare my team for an AI workshop?**
The most important preparation is openness. Ask your team to think about two things beforehand: which part of their work takes the most time, and where they already (informally) use AI tools. That information is invaluable for the workshop. No technical knowledge is required. The workshop is designed so that everyone can participate, from directors to frontline staff.
