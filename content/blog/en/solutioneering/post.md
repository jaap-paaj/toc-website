---
title: 'Solutioneering: When the Tool Becomes the Problem'
date: '2026-04-03'
intro: >-
...
**How do you prevent Solutioneering?**
By following three rules: state the problem without mentioning technology, observe the work before designing a solution, and define clear success criteria before you start building. If the brief names a specific tool ("build a chatbot"), rewrite it as a problem ("cut complaint response time in half").

**What does a failed AI project cost?**
Direct costs (licences, development, consultancy) range from tens of thousands to hundreds of thousands of euros. The indirect costs are larger: loss of confidence in AI initiatives, a team unavailable for other projects, and the opportunity cost of the right project that never started. The cheapest investment is spending two weeks sharpening the problem before you start building.
